...
export const HourlyForecast = data => {
  ...
  hourlyContainer.className =
    'bg-surface border border-line rounded-lg px-5 py-4 flex flex-col gap-3 w-full min-h-0 min-w-0 shrink-0 overflow-hidden';
  ...
  horlyDataContainer.className =
    'flex gap-1.5 overflow-x-auto overflow-y-hidden pb-2 -mx-1 px-1 max-w-full';
